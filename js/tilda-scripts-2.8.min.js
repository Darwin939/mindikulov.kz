...
(window.browserLang = (
  ...
  (function (e) {
    if (
      ...
      var t = function () {
        for (
          var t = document.body.querySelectorAll(".t-cover__carrier"),
            o = e(window).height(),
            i = 0,
            r = 0,
            n = t.length;
          ...
          (c = t[r]),
            (s = c.style),
            s.height.indexOf("vh") > -1 &&
              ((i = parseInt(s.height, 10) / 100),
              (d = Math.round(o * i) + "px"),
              (l = e(c).parent(".t-cover")),
              l &&
                (l = l[0]) &&
                ((p = l.querySelector(".t-cover__filter")),
                (u = l.querySelector(".t-cover__wrapper")),
                p && (p.style.height = d),
                u && (u.style.height = d),
                (s.height = l.style.height = d)));
        ...
        e(window).width() < 480
          ? (e(document).ready(function () {
              ...
              e("div[data-customstyle=yes]").each(function (t) {
                e(this).css("font-size").replace("px", "") > 26 &&
                  (e(this).css("font-size", ""),
                ...
                e(this)
                  ...
                  .each(function () {
                    ...
                    i > t &&
                      ...
                      console.log(e(this)),
                      o.css("overflow", "auto"),
                      i - 3 > t && o.css("word-break", "break-all"));
                  });
              });
            }))
          : e(window).width() < 900 &&
            e(document).ready(function () {
              var t;
              e("div[data-customstyle=yes]").each(function (t) {
                e(this).css("font-size").replace("px", "") > 30 &&
                  (e(this).css("font-size", ""),
                  e(this).css("line-height", ""));
              }),
                e("[field]")
  ...
  (function (e) {
    ...
    (t.prototype.videoTags = []),
      (t.prototype.defaultConfig = { isNeedStop: !1 }),
      (t.prototype.videoConfigs = []),
      (t.prototype.registerNewVideo = function (e, t) {
        if (!(e instanceof HTMLVideoElement))
          throw new Error("Wrong tag passed into registerNewVideo");
        return (
          -1 == this.videoTags.indexOf(e) &&
          (this.videoTags.push(e),
          this.videoConfigs.push(void 0 === t ? this.defaultConfig : t),
          this.scrollCb("", !0),
          !0)
        );
      }),
      (t.prototype.unergisterVideo = function (e) {
        ...
        var t;
        return (
          (t = this.videoTags.indexOf(e)) > -1 &&
          ("function" == typeof e.remove
            ? e.remove()
            : e.parentNode && e.parentNode.removeChild(e),
          this.pauseVideo(e, this.videoConfigs[t]),
          this.videoTags.splice(t, 1),
          this.videoConfigs.splice(t, 1),
          !0)
        );
      }),
      ...
      (t.prototype.scrollCb = function (t, o) {
        for (
          var i = e(window).height(),
            r = null,
            n = 0,
            a = this.videoTags.length;
          n < a;
          n++
        ) {
          if (
            ((r = this.videoTags[n]),
            (_vrect = this.getVideoBoundingRect(r, !1)),
            Math.abs(_vrect.top) < i && Math.abs(_vrect.top) > i / 2)
          ) {
            var c = 1 - (Math.abs(_vrect.top) - i / 2) / (i / 2) - 0.2;
            c > 0 && c <= 1 && 0 != r.volume && (r.volume = c);
          }
          Math.abs(_vrect.top) > i || 0 == _vrect.height
            ? this.pauseVideo(r, this.videoConfigs[n])
            : (o && r.play(), r.paused && r.loop && r.play());
        }
      }),
  ...
  (function (e) {
    function t() {
      ...
      var t = 0.25;
      (this.itemTransitionTop = this.itemHeight * t),
    ...
    function o(t) {
      var o = e("#rec" + t),
        ...
        r = o.find("div[data-hook-content]").outerHeight();
      if (r > 300 && i < r + 40) {
        r = r + 120;
        if (
          (r > 1e3 && (r += 100),
          console.log("auto correct cover height: " + r),
          o.find(".t-cover").height(r),
          o.find(".t-cover__filter").height(r),
          o.find(".t-cover__carrier").height(r),
          o.find(".t-cover__wrapper").height(r),
          0 == window.isMobile &&
            setTimeout(function () {
    ...
    function i(t) {
      var o = document.body.querySelector("#rec" + t);
      if (o) {
        var i = o.querySelector(".t-cover__carrier"),
          r = e(i).attr("data-content-video-url-youtube"),
          n = e(i).attr("data-content-video-url-mp4"),
          a = e(i).attr("data-content-video-url-webm"),
        ...
        return !(
          ...
          a ||
          !i ||
          "fixed" != i.dataset.contentCoverParallax ||
          window["cover" + t + "fixbackgroundstyles"]
        );
      }
    }
    function r(e) {
    ...
    function n(e) {
      ...
      if (i(e)) {
        ...
        (r.style.height = 0),
          (o.style.height = n),
          (window["cover" + e + "fixbackgroundstyles"] = !0);
      }
    }
    function a(e, t, o) {
      -1 == e.indexOf("https://www.youtube.com/embed") &&
        (e = "https://www.youtube.com/embed" + ("/" == e[0] ? e : "/" + e));
      var i = function (e) {
          for (var t = e.split("/"), o = null, i = 0, r = t.length; i < r; i++)
            "embed" == t[i] && (o = t[i + 1]);
          return o;
        },
    ...
    function c(t, o, i) {
      var r,
        ...
        c = 0;
      n.scroll(function () {
        r && (window.clearTimeout(r), c >= 15 && (s(a, n, o, i), (c = 0)), c++),
    ...
    function l(t, o) {
      ...
      if ((a > 0 && (c = 1 * parseFloat(a)), "yes" != r)) {
        ...
        var p = l,
          ...
          m = u,
          v = 1;
        if (("yes" == n || ((f = f + 110 + 110), (m = u - 220)), m < d))
          if (u < d) v = d / u + 0.02;
          else v = u / d + 0.02;
        var w = Math.floor(h * v),
          g = Math.floor(f * v),
          y = g - d,
          b = w - l;
        i.height(g + "px"),
          i.width(w + "px"),
          y > 0 && i.css("margin-top", -Math.floor(y / 2) + "px"),
          b > 0 && i.css("margin-left", -Math.floor(b / 2) + "px");
      } else {
        o || (u = Math.floor(t.width() * c)),
          o && o.indexOf("vh") > -1
            ? (u = Math.floor(window.innerHeight * (parseInt(o) / 100)))
            : o && (u = parseInt(o)),
          i.css("width", "100%"),
          i.height(u + "px");
      }
    ...
    (t.prototype.defaultConfig = {
      ...
      (t.prototype.sequenceObjects = []),
      (t.prototype.recalculateAllSequencesOffsets = function () {
        ...
        var i = e.querySelector('[data-hook="sequence-holder"]'),
          ...
          a = function () {
            var t = Array.prototype.slice.call(
                e.querySelectorAll('[data-hook="sequence-item"]'),
                0
              ),
              o = [];
            return (
              t.forEach(
                jQuery.proxy(function (e, t, i) {
                    ...
                    o.push({
                      ...
                      topOffset:
                        this.getAbsoluteTopOffset(
                          e.querySelector(".txt-holder")
                        ) - (t == i.length - 1 ? 0 : this.topOffsetShift),
                      backgroundHolder: a,
                    });
                }, this)
              ),
      ...
      (t.prototype.fixTextBlocksPosition = function (e) {
        (txtBlocks = Array.prototype.slice.call(
          e.querySelectorAll('[data-hook="item-text"]'),
          0
        )),
          txtBlocks.forEach(function (e, t, o) {
      ...
      (t.prototype.getAbsoluteTopOffset = function (e) {
        var t = e.offsetTop;
        for (e = e.offsetParent; null != e; )
          (t += e.offsetTop), (e = e.offsetParent);
        return t;
      }),
      (t.prototype.processSequence = function (e) {
        0 == e.started &&
          ((e.prevBackgroundColor = document.body.style.backgroundColor),
          (document.body.style.backgroundColor = "rgb(0, 0, 0)"),
          (e.started = !0));
        e.sequenceBlock, e.sequenceHolder;
        for (
          var t, o, i, r, n = e.items, a = null, c = 0, s = n.length;
          c < s;
          c++
        )
          if (
            ((t = n[c].node),
            t.querySelector(".txt-holder"),
            (r = t.getBoundingClientRect()),
            r.top < this.itemTransitionTop &&
              r.bottom < r.height + this.itemTransitionTop &&
              r.bottom > this.itemTransitionTop)
          ) {
            a = c;
            break;
          }
        if (null != a) {
          (i = r.top / this.itemTransitionTop),
            i > 1 ? (i = 1) : i < 0 && (i = 0);
          for (c = 0, s = n.length; c < s; c++)
            (t = n[c].node),
              (o = n[c].backgroundHolder.style),
              "fixed" != o.position && (o.position = "fixed"),
              c == a
                ? ((o.opacity = 1 - i),
                  (t.querySelector(".txt-holder").style.opacity = 1 - i))
                : c == a - 1
                ? ((o.opacity = i),
                  (t.querySelector(".txt-holder").style.opacity = i))
                : ((o.opacity = 0),
                  (t.querySelector(".txt-holder").style.opacity = 0));
        }
      }),
      (t.prototype.stopSequence = function (e) {
        0 != e.started &&
          (e.items.forEach(function (e, t, o) {
            (e.backgroundHolder.style.position = "relative"),
              (e.backgroundHolder.style.display = "block"),
              (e.backgroundHolder.style.opacity = 1);
          }),
          (document.body.style.backgroundColor = e.prevBackgroundColor),
          (e.started = !1));
      }),
      (t.prototype.scrollCb = function () {
        ...
        for (var t, o = 0, i = this.sequenceObjects.length; o < i; o++) {
          ...
          r.top < 0 &&
          r.bottom > 0 &&
          r.bottom > r.height - t.sequenceHeight - 100
            ? this.processSequence(t)
            : this.stopSequence(t);
        }
      }),
      (t.prototype.setScrollCb = function () {
        (this._scrollCb = jQuery.proxy(this.scrollCb, this)),
          e(window).bind("scroll", t_throttle(this._scrollCb, 200));
      }),
      (window.sequenceController = new t()),
      (window.processVideo = function (t) {
        (mp4Src = e(t).attr("data-content-video-url-mp4")),
          (webmSrc = e(t).attr("data-content-video-url-webm")),
          e(t).css("background-color", "transparent"),
      ...
      (window.cover_init = function (t) {
        e(document).ready(function () {
          var i = document.body.querySelector("#coverCarry" + t),
            ...
            p = a.attr("data-content-video-url-webm"),
            u = a.attr("data-content-video-url-youtube"),
          ...
          if (
            ...
            ("" !== l || "" !== p || "" !== u) && 0 == window.isMobile)
          )
            if ("" != u || ("" == l && "" == p)) {
              if ("" != u) {
                a.css("background-color", "#000000"),
                  a.css("background-image", ""),
                  a.attr("data-content-cover-bg", "");
                (x = 0), (k = e(window));
                k.scroll(function () {
                  b && window.clearTimeout(b),
                    (b = window.setTimeout(function () {
                      var e, t, o, r;
                      ((x = a.find("iframe").length), x > 0) ||
                        ((e = a.offset().top),
                        (t = a.height()),
                        (o = k.scrollTop()),
                        (r = k.height()),
              ...
              "fixed" == d &&
                (s.indexOf("vh") > -1 &&
                  parseInt(s) > 100 &&
                  (a.css("height", "100vh"), (_ = "yes")),
                s.indexOf("px") > -1 &&
                  parseInt(s) > e(window).height() &&
                  (a.css("height", "100vh"), (_ = "yes")));
              var x = "",
                k = e(window),
                T = a.parent();
              k.scroll(function () {
                ...
                (b = window.setTimeout(function () {
                  ...
                  if (
                    ...
                    videoLoadProcessor.registerNewVideo(r), (x = 1);
                  }
                }, 100)),
                "fixed" == d && "yes" == _) &&
                  ((e = T.offset().top),
                  ...
                  o >= e + t - i
                    ? (a.css("position", "absolute"),
                      ...
                      a.css("top", "auto"))
                    : o >= e
                    ? (a.css("position", "fixed"), a.css("top", "0px"))
                    : o < e &&
                      (a.css("position", "relative"), a.css("top", "auto")));
              }),
                k.scroll();
            }
          if ("dynamic" == d && 0 == window.isMobile) {
            var C = a.offset().top - (a.offset().top - e(window).height());
            a.height() < e(window).height() && a.height(a.height() + 0.2 * C),
              a.parallax(0.2, !0);
          }
          if ("yes" == m && "" != c && "" == l && "" == p && "" == u) {
            var S = "";
    ...
    (window.processYoutubeVideo = function (t, o) {
      ...
      var i = function () {
        var i,
          r = e(t),
          n = r.attr("data-content-video-url-youtube"),
        ...
        if (
          ...
          new YT.Player(u, {
            events: {
              onReady: function (e) {
                c(t, e.target, s),
                  e.target.setVolume && "yes" != s && e.target.setVolume(0),
                  e.target.setLoop(!0);
              },
              onStateChange: function (t) {
                if (
                  (t.target.setVolume && "yes" != s && t.target.setVolume(0),
                  -1 === t.data)
                ) {
                ...
                t.data === YT.PlayerState.PLAYING
                  ? (i = window.setInterval(function () {
                      ...
                      e + 1 > o &&
                        ...
                        (t.target.seekTo(0),
                        "yes" === d &&
                          (t.target.stopVideo(), t.target.clearVideo()));
                    }, 1e3))
  ...
  (function (e) {
    ...
    (t.prototype.defaultConfig = { single: !1, context: null }),
      (t.prototype.addEventListener = function (e, t, o) {
        (evtCallbacks = this._getEventCallbacks(e)),
          evtCallbacks || (evtCallbacks = this.callbacks[e] = []),
          evtCallbacks.push({
            callback: t,
      ...
      (t.prototype.removeEventListener = function (e, t) {
        ...
        if (!o) return !1;
        for (var i, r = 0, n = o.length; r < n; r++)
          if (((i = o[r]), t === i.callback)) return o.splice(r, 1), !0;
        return !1;
      }),
      (t.prototype.emitEvent = function (e, t) {
        var o = [];
        extend(o, this._getEventCallbacks(e));
        for (var i, r, n, a = 0, c = o.length; a < c; a++)
          (i = o[a]),
            (r = i.callback),
            (n = i.config),
            n.context ? r.call(n.context, t) : r(t),
            n.single && this.removeEventListener(e, r);
      }),
  ...
  (function (e) {
    e(document).ready(function () {
      if (
        0 == window.isMobile &&
        "yes" !== e("#allrecords").attr("data-blocks-animationoff") &&
        0 == window.isSearchBot
      ) {
        e(".r").each(function (t) {
          e(this).attr("style") &&
            -1 !== e(this).attr("style").indexOf("background-color") &&
            e(this).attr("data-animationappear", "off");
        });
        var t = e(".r").not(
        ...
        function i() {
          if (t.length)
            for (var i, r, n, a = t.length - 1; a >= 0; a--)
              (i = e(t[a])),
                (r = i.offset().top),
                (n =
                  i.outerHeight() <= 100
                    ? o.scrollTop() + o.height()
                    : o.scrollTop() + o.height() - 100),
                r < n &&
                  (i.removeClass("r_hidden"),
                  i.addClass("r_showed"),
                  t.splice(a, 1));
        }
        t.each(function (t) {
          (a = e(this).offset().top),
            (b = o.scrollTop() + o.height() + 300),
            a > 1e3 && a > b
              ? e(this).addClass("r_hidden")
              : e(this).addClass("r_showed"),
            e(this).addClass("r_anim");
        }),
          o.bind("scroll", t_throttle(i, 200)),
          i();
      }
      "none" === e("html").css("display") && e("html").css("display", "block"),
        e("body").height() + 70 < e(window).height()
          ? e(".t-tildalabel").css("display", "none")
          : e(".t-tildalabel").attr("style", "display: block !important");
    });
  })(jQuery),
  (function (e) {
    function t() {
    ...
    function o() {
      var t,
        ...
        i,
        r = e(window).width(),
        n = e("div.r[data-screen-max], div.r[data-screen-min]");
      n.each(function (n) {
        (i = e(this).css("display")),
          (t = e(this).attr("data-screen-max")),
          void 0 === t && (t = 1e4),
          (t = parseInt(t)),
          (o = e(this).attr("data-screen-min")),
          void 0 === o && (o = 0),
          (o = parseInt(o)),
          o <= t &&
            (r <= t && r > o
              ? "block" != i && e(this).css("display", "block")
              : "none" != i && e(this).css("display", "none"));
      });
    }
    e(document).ready(function () {
      t(),
        o(),
        e(window).bind("resize", t_throttle(t, 200)),
        e(window).bind("resize", t_throttle(o, 200));
    });
  })(jQuery),
  (function (e) {
    function t(t, o) {
      ...
      if ((c > 0 && (s = 1 * parseFloat(c)), "yes" != a)) {
        ...
        var g = Math.floor(f * w),
          y = Math.floor(m * w),
          b = y - l,
          _ = g - p;
        n.height(y + "px"),
          n.width(g + "px"),
          b > 0 && n.css("margin-top", -Math.floor(b / 2) + "px"),
          _ > 0 && n.css("margin-left", -Math.floor(_ / 2) + "px");
      } else {
        r || (h = Math.floor(i.width() * s)),
          r && r.indexOf("vh") > -1
            ? (h = Math.floor(window.innerHeight * (parseInt(r) / 100)))
            : r && (h = parseInt(r)),
          n.css("width", "100%"),
          n.height(h + "px");
      }
    ...
    (e.fn.videoBG = function (o, i) {
      ...
      var r = e(this);
      if (r.length) {
        ("static" != r.css("position") && r.css("position")) ||
          r.css("position", "relative"),
          0 == i.width && (i.width = r.width()),
          0 == i.height && (i.height = r.height()),
          i.textReplacement &&
            ((i.scale = !0),
            r.width(i.width).height(i.height).css("text-indent", "-9999px"));
        var n = e.fn.videoBG.video(i);
        return (
          i.scale && n.height(i.height).width(i.width),
          r.append(n),
          void 0 === r.attr("data-content-video-nomute") &&
            r.find("video").prop("muted", !0),
          t(n, i.height),
          n.find("video")[0]
        );
      }
      ...
      (e.fn.videoBG.setFullscreen = function (t) {
        var o = e(window).width(),
          i = e(window).height();
        if (
          (t.css("min-height", 0).css("min-width", 0),
          t.parent().width(o).height(i),
          o / i > t.aspectRatio)
        ) {
      ...
      (e.fn.videoBG.video = function (t) {
        ...
        (r
          ...
          .css("z-index", t.zIndex)
          .attr("poster", t.poster)
          .css("top", 0)
          .css("left", 0)
          .css("min-width", "100%")
          .css("min-height", "100%"),
        r.prop("autoplay", t.autoplay),
        r.prop("loop", t.loop),
        r.prop("muted", t.muted),
        t.volume > 0 ? r.prop("volume", t.volume) : r.prop("volume", 0),
        t.fullscreen) &&
        ...
        t.loop &&
          ...
          e.fn.videoBG.supportsVideo() &&
            (e.fn.videoBG.supportType("webm") && "" != t.webm
              ? r.attr("src", t.webm)
              : e.fn.videoBG.supportType("mp4") && "" != t.mp4
              ? r.attr("src", t.mp4)
              : r.attr("src", t.ogv));
        var a = e("<img/>");
        return (
          a
            ...
            .css("min-width", "100%")
            .css("min-height", "100%"),
          e.fn.videoBG.supportsVideo() ? o.html(r) : o.html(a),
          t.textReplacement &&
            (o.css("min-height", 1).css("min-width", 1),
            r.css("min-height", 1).css("min-width", 1),
            a.css("min-height", 1).css("min-width", 1),
            o.height(t.height).width(t.width),
            r.height(t.height).width(t.width),
            a.height(t.height).width(t.width)),
          e.fn.videoBG.supportsVideo(),
          o
        );
      }),
  ...
  (function (e) {
    ...
    t.resize(function () {
      ...
      (e.fn.parallax = function (i, r) {
        function n() {
          ...
          c.each(function () {
            ...
            if (!(n + c < r || n > r + o)) {
              ...
              s
                ? (this.style["-webkit-transform"] = "translateY(" + l + "px)")
                : (this.style.top = l + "px");
            }
          });
        }
        var a,
          c = e(this),
          s = void 0 !== document.body.style["-webkit-transform"];
        s && c.css("position", "relative"),
          ...
          (arguments.length < 2 || null === r) && (r = !0),
          n(),
          e(window).resize(window.correctFirstTop4Parallax),
  ...
  (function (e) {
    (Tilda.sendEcommerceEvent = function (t, o) {
      ...
      if (
        void 0 === t ||
        ("add" != t && "remove" != t && "purchase" != t && "detail" != t)
      )
        return !1;
      var i,
        r,
      ...
      for (i = 0; i < o.length; i++) {
        (a = o[i]),
          ...
          void 0 !== a.options &&
            a.options.length > 0 &&
            e.each(a.options, function (e, t) {
              n += t.option + ": " + t.variant + "; ";
            });
        var h = { name: a.name, price: a.price, variant: n, quantity: 1 };
        a.id && a.id > 0 && ((id = a.id), (h.id = a.id)),
          a.uid && a.uid > 0 && ((p = a.uid), (h.uid = a.uid)),
          a.recid && a.recid > 0 && ((l = a.recid), (h.recid = a.recid)),
          a.lid && a.lid > 0 && ((u = a.lid), (h.lid = a.lid)),
          a.sku && a.sku > 0 && (h.sku = a.sku),
          (d[d.length] = h);
      }
      ("add" != t && "remove" != t) ||
        ((r = "/tilda/cart/" + t + "/"),
        ...
        "detail" == t &&
          ...
          p > 0
            ? (r += p + "/")
            : (l > 0 && (r += "r" + l), u > 0 && (r += "-l" + u))),
        "purchase" == t && (r = "/tilda/rec" + l + "/payment/");
      h = { ecommerce: {} };
      (h.ecommerce[t] = { products: d }),
        Tilda.sendEventToStatistics(r, c, h, s);
    }),
      (Tilda.sendEventToStatistics = function (t, o, i, r) {
        ...
        if (
          ((l =
            e("#allrecords").data("tilda-currency") ||
            e(".t706").data("project-currency-code") ||
            "RUB"),
          ...
          if (
            ...
            (i = {
              ...
              window.tildaForm.tildapayment &&
                ...
                (i.ecommerce.purchase.actionField.coupon =
                  window.tildaForm.tildapayment.promocode),
              (i.event = "purchase");
          else if (
            i &&
            i.ecommerce &&
            (i.ecommerce.add && i.ecommerce.add.products
              ? (a = i.ecommerce.add.products)
              : i.ecommerce.remove && i.ecommerce.remove.products
              ? (a = i.ecommerce.remove.products)
              : i.ecommerce.detail &&
            ...
            for (c = 0; c < a.length; c++)
              a[c].id ||
                (a[c].sku
                  ...
                  : a[c].recid &&
                    a[c].lid &&
                    (a[c].id = a[c].recid + "_" + a[c].lid));
            i.ecommerce.add && i.ecommerce.add.products
              ? ((i.ecommerce.add.products = a), (i.event = "addToCart"))
              : i.ecommerce.remove && i.ecommerce.remove.products
              ? ((i.ecommerce.remove.products = a),
                (i.event = "removeFromCart"))
              : i.ecommerce.detail && i.ecommerce.detail.products
              ? ((i.ecommerce.detail.products = a), (i.event = "viewProduct"))
              : (n
                  ? ((i.event = "pageView"), (i.eventAction = t))
                  : (i.event = t),
                (i.title = o),
                (i.value = r));
          }
            ...
            (n
              ? i && i.event
                ? "purchase" == i.event
                  ...
                  : "removeFromCart" == i.event && i.ecommerce.remove
            ...
            if (i && i.event) {
              try {
                if (
                  ...
                  for (g = 0; g < p; g++)
                    (w = i.ecommerce.purchase.products[g]),
                      ga("ec:addProduct", {
                        id: w.id || g,
                        name: w.name,
                  ...
                  for (g = 0; g < p; g++)
                    (w = i.ecommerce.remove.products[g]),
                      ga("ec:addProduct", {
                        id: w.id || g,
                        name: w.name,
                        price: parseFloat(w.price).toFixed(2),
                  ...
                  for (g = 0; g < p; g++)
                    (w = i.ecommerce.detail.products[g]),
                      ga("ec:addProduct", {
                        id: w.id || g,
                        name: w.name,
                        price: parseFloat(w.price).toFixed(2),
        ...
        if (
          ...
          if (n) {
            var u = { title: o };
            r > 0
              ? ((u.params = { order_price: r }),
                l && (u.params.currency = l),
                ym(window.mainMetrikaId, "hit", t, u))
              : ym(window.mainMetrikaId, "hit", t, u);
          } else
            r > 0
              ? ((u = { order_price: r }),
                l && (u.currency = l),
                ym(window.mainMetrikaId, "reachGoal", t, u))
              : ym(window.mainMetrikaId, "reachGoal", t);
        if (
          (window.mainMetrika > "" &&
            window[window.mainMetrika] &&
            (n
              ? r > 0
                ? window[window.mainMetrika].hit(t, {
                    title: o,
                    order_price: r,
                    params: i,
                  })
                : window[window.mainMetrika].hit(t, { title: o })
              : r > 0
              ? window[window.mainMetrika].reachGoal(t, {
                  title: o,
                  params: i,
                  order_price: r,
                })
          ...
          try {
            if (n)
              if (
                -1 == t.indexOf("tilda/") ||
                (-1 == t.indexOf("/payment/") && -1 == t.indexOf("/submitted/"))
              )
                if (i && i.event && r > 0)
        ...
        if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && 0 == d)
          try {
            if (n) {
              var f = e("#allrecords").data("vk-price-list-id")
                  ? parseInt(e("#allrecords").data("vk-price-list-id"))
                  : 0,
                m = "",
                v = !1;
              if (i && i.event)
                if (
                  ((v = { products: [], currency_code: "", total_price: 0 }),
                  ...
                  if (r > 0 && f > 0) {
                    ...
                    (m = "t-add-to-cart"),
                      i.ecommerce.add[0] &&
                        i.ecommerce.add[0].uid &&
                        (m += "-" + i.ecommerce.add[0].uid);
                else if ("viewProduct" == i.event && i.ecommerce.detail)
                  if (r > 0 && f > 0) {
                    v.currency_code = l;
                    (p = i.ecommerce.detail.products.length), (h = []);
                    ...
                    (m = "t-view-product"),
                      i.ecommerce.detail[0] &&
                        i.ecommerce.detail[0].uid &&
                        (m += "-" + i.ecommerce.detail[0].uid);
                  ...
                  if (r > 0 && f > 0) {
                    ...
                    (m = "t-remove-product"),
                      i.ecommerce.remove[0] &&
                        i.ecommerce.remove[0].uid &&
                        (m += "-" + i.ecommerce.remove[0].uid);
                else m = i.event;
              else if (
                -1 != t.indexOf("tilda/") &&
                -1 != t.indexOf("/payment/")
              ...
              f > 0 && v && v.currency_code
                ? (VK.Retargeting.Event("purchase"),
                  VK.Retargeting.ProductEvent(f, m, v))
                : VK.Retargeting.Event(m);
        ...
        "function" == typeof window.tildastat &&
          (n
            ? (t.indexOf("payment") > 0 &&
                t.indexOf("tilda/form") > -1 &&
                (t = t.replace("tilda/form", "tilda/rec")),
              window.tildastat("pageview", { page: t }))
            : window.tildastat("pageview", { page: "/tilda/event/" + t }));
      }),
      (Tilda.saveUTM = function () {
        try {
          ...
          if (
            ...
            for (r in n)
              (i = n[r].split("=")),
                "utm_" == i[0].substring(0, 4) && (o = o + n[r] + "|||");
            if (o.length > 0) {
              var a = new Date();
      ...
      e(document).ready(function () {
        ...
        (8 != o && 9 != o) ||
          e(".t-btn").each(function () {
            var t = e(this).attr("href");
            e(this).find("table").length > 0 &&
              t > "" &&
              -1 == t.indexOf("#popup:") &&
              -1 == t.indexOf("#price:") &&
        ...
        try {
          (1 == e("#allrecords").length &&
            "no" == e("#allrecords").data("tilda-cookie")) ||
            Tilda.saveUTM();
        } catch (e) {}
        e(".r").off("click", "a.js-click-stat"),
          e(".r").on("click", "a.js-click-stat", function (t) {
            ...
            if (
              (o ||
                (o =
                  "/tilda/click/".$(this).closest(".r").attr("id") +
                  "/?url=" +
                  r),
              Tilda.sendEventToStatistics(o, i),
                    ...
                    if (
                      (-1 != r.indexOf("?") &&
                        ...
                        -1 != i.indexOf("#") &&
                          ...
                          (i = i[0])),
                        (i = i.split("&"))),
                      0 == e("#tildaredirectform").length
                        ? e("body").append(
                            '<form id="tildaredirectform" target="_blank" method="GET" action="' +
                              r +
                        ...
                        (o = i[t].split("=")),
                          o &&
                            ...
                            (a +=
                              ...
                              (o[1] ? o[1] : "") +
                              '">');
                    e("#tildaredirectform").html(a),
                      e("#tildaredirectform").submit();
          ...
          (Tilda.showFormError = function (e, t) {
            ...
            (o && 0 != o.length) ||
              (e.prepend('<div class="js-errorbox-all"></div>'),
              (o = e.find(".js-errorbox-all")));
            var i = o.find(".js-rule-error-all");
            (i && 0 != i.length) ||
              (o.append('<p class="js-rule-error-all"></p>'),
              (i = o.find(".js-rule-error-all"))),
              "string" == typeof t
                ? i.html(t)
                : t && t.responseText
                ? i.html(t.responseText + ". Later, plaese try again.")
                : t && t.statusText
                ? i.html(
                    "Error - " + t.statusText + ". Later, plaese try again."
                  )
          ...
          (Tilda.robokassaPayment = function (t, o, i) {
            return e.ajax({
              ...
              dataType: "text",
              success: function (r) {
                o.removeClass("t-btn_sending"),
                  o.data("form-sending-status", "0"),
                  o.data("submitform", "");
                var n = o.closest(".r").attr("id");
                if ("{" == r.substring(0, 1)) {
                  if (
                    (window.JSON && window.JSON.parse
                      ? (json = window.JSON.parse(r))
                      : (json = e.parseJSON(r)),
                    !json)
                  )
                    return void Tilda.showFormError(t, !1);
                  if (json.error > "")
                    return void Tilda.showFormError(t, json.error);
                } else if ("http" == r.substring(0, 4)) {
                  Tilda.sendEventToStatistics(
                    "/tilda/payment/" + n + "/click/",
                    "Payment button: " + o.val(),
                    "",
                    i
                  );
                  var a = r;
      ...
      setTimeout(function () {
        0 === e("#tildacopy").length
          ? e("body")
              ...
              .each(function (t, o) {
                -1 !== o.nodeValue.indexOf("'t remove this l") &&
                  e("#allrecords").after(
                    '<div class="t-tildalabel t-tildalabel-free"><div class="t-tildalabel-free__main"><a href="https://tilda.cc" target="_blank" style="padding-bottom:12px; display: block;"><img style="width:40px;" src="https://static.tildacdn.com/img/tildacopy.png"></a><div style="padding-bottom: 15px;">This site was made on <a href="https://tilda.cc" target="_blank" style="text-decoration: none; color:inherit;">Tilda — a website builder</a> that helps to&nbsp;create a&nbsp;website without any code</div><a href="https://tilda.cc/registration/" target="_blank" style="display: inline-block; padding: 10px 20px; font-size: 13px; border-radius: 50px; background-color: #fff; color:#000; text-decoration: none;">Create a website</a></div><div class="t-tildalabel-free__links-wr">' +
                      ("RU" === window.browserLang
                        ? '<a class="t-tildalabel-free__txt-link" href="http://help-ru.tilda.ws/white-label" target="_blank">Как удалить этот лейбл?</a>'
                        : '<a class="t-tildalabel-free__txt-link" href="http://help.tilda.ws/white-label" target="_blank">How to remove this block?</a>') +
                      "</div></div>"
                  );
              })
          : e("body").height() + 70 < e(window).height() ||
